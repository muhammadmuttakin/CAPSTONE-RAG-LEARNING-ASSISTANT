...
class RecommendationEngine:
    """Smart course recommendation based on learning path and level"""
    ...
    def answer_recommendation_query(
        ...
        """
        Answer recommendation queries using LLM.
        ...
        try:
            ...
            # Get all courses
            all_courses = self.data_loader.courses[:20]  # Limit to first 20 untuk context
