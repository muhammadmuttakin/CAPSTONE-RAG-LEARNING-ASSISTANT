...
class ProgressTracker:
    ...
    def _load_data(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # Konversi struktur API → struktur lama agar logic lama tidak berubah
            converted = {
                "user": {
            ...
            for c in target_user.get("classes", []):
                converted["user"]["courses"].append({
                    ...
                    "progress": int(c.get("progress", 0)),  # string → int
...
"""
    ...
    def answer_tracking_query(self, query: str, session_id: str = None) -> str:
        """Answer progress tracking questions using LLM with conversation history"""
